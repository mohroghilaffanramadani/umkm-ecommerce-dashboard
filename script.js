...
const productsData = [
    {
        ...
        price: 15000,
        originalPrice: 20000,
        description: "Keripik singkong dengan bumbu pedas khas, renyah dan gurih. Diproduksi secara homemade dengan bahan-bahan pilihan.",
        image: "assets/products/pro7.jpg",
        video: "https://assets.mixkit.co/videos/preview/mixkit-close-up-of-a-woman-eating-a-snack-of-fried-chips-39808-large.mp4",
        rating: 4.5,
        reviewCount: 124,
        stock: 50,
    ...
    },
    {
        ...
        description: "Tas anyaman rotan dengan desain modern, kuat dan tahan lama. Cocok untuk kegiatan sehari-hari atau sebagai fashion item.",
    ...
    },
    {
        ...
        description: "Kain batik tulis cap dengan motif tradisional yang elegan. Diproses dengan teknik pewarnaan alami yang ramah lingkungan.",
        image: "assets/products/pro6.jpg",
        video: "https://assets.mixkit.co/videos/preview/mixkit-hands-of-a-person-sewing-with-a-sewing-machine-41592-large.mp4",
        rating: 4.7,
        reviewCount: 203,
        stock: 35,
    ...
    },
    {
        ...
        price: 75000,
        originalPrice: 95000,
        description: "Madu hutan murni yang diambil langsung dari lebah liar di hutan Kalimantan. Kaya akan nutrisi dan antioksidan.",
    ...
    },
    {
        ...
        price: 35000,
        originalPrice: 50000,
        description: "Lilin aromaterapi dengan essential oil lavender untuk relaksasi. Membantu mengurangi stres dan meningkatkan kualitas tidur.",
        image: "assets/products/pro5.jpg",
        video: "https://assets.mixkit.co/videos/preview/mixkit-candle-flame-flickering-close-up-4083-large.mp4",
        rating: 4.6,
        reviewCount: 167,
        stock: 80,
    ...
    },
    {
        ...
        price: 65000,
        originalPrice: 90000,
        description: "Gelang perak dengan desain unik handmade. Cocok untuk aksesori harian atau acara khusus.",
    ...
    },
    {
        ...
        price: 45000,
        originalPrice: 60000,
        description: "Beragam kue kering lebaran dengan rasa yang lezat dan tekstur yang renyah. Tersedia dalam beberapa pilihan rasa.",
        image: "https://images.unsplash.com/photo-1612203985729-70726954388c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80",
        video: "https://assets.mixkit.co/videos/preview/mixkit-a-chef-preparing-a-dessert-33295-large.mp4",
        rating: 4.8,
        reviewCount: 278,
        stock: 120,
    ...
    },
    {
        ...
        price: 25000,
        originalPrice: 35000,
        description: "Sabun alami dengan ekstrak lavender dan minyak zaitun. Membersihkan kulit tanpa membuat kering, cocok untuk semua jenis kulit.",
    ...
    },
    {
        ...
        description: "Vas bunga keramik dengan motif etnik yang indah. Dibuat dengan teknik pembakaran tradisional untuk hasil yang maksimal.",
        image: "assets/products/pro4.jpg",
        video: "https://assets.mixkit.co/videos/preview/mixkit-hands-of-a-potter-forming-a-clay-pot-41591-large.mp4",
        rating: 4.5,
        reviewCount: 74,
        stock: 30,
    ...
    },
    {
        ...
        price: 25000,
        originalPrice: 50000,
        description: "Minyak goreng kelapa murni yang diolah secara tradisional. Lebih sehat dan cocok untuk segala jenis masakan.",
...
const domElements = {
    ...
    paymentMethodOptions: document.querySelectorAll('input[name="payment-method"]'),
...
const updateActiveNav = () => {
    // Jika baru saja melakukan manual navigation, skip update berdasarkan scroll
    ...
    // Set active state berdasarkan section yang terlihat
    if (currentSection) {
        navLinks.forEach(link => {
        ...
        // Default ke home jika di atas semua section
        const homeLink = document.querySelector('.nav-link[href="#beranda"]');
        const mobileHomeLink = document.querySelector('.mobile-nav-link[href="#beranda"]');
...
// Fungsi untuk langsung set active nav berdasarkan klik
    ...
    products.forEach(product => {
        ...
        productCard.innerHTML = `
            <div class="product-image-container">
                ...
                ${hasDiscount ? `<span class="product-badge" style="left: ${product.isFeatured ? '90px' : '15px'}; background-color: var(--danger-color);">${discountPercentage}% OFF</span>` : ''}
            ...
            <div class="product-content">
                ...
                <div class="product-price">
                    ...
                    ${hasDiscount ? `<span style="font-size: 0.9rem; color: var(--gray-color); text-decoration: line-through; margin-left: 8px;">${formatCurrency(product.originalPrice)}</span>` : ''}
                </div>
...
const renderRecommendedProducts = () => {
    // For demo, we'll show featured products as recommended
    const recommendedProducts = productsData.filter(product => product.isFeatured).slice(0, 4);
...
const filterProducts = () => {
    ...
    if (currentFilter.category !== 'semua') {
        filteredProducts = filteredProducts.filter(product => product.category === currentFilter.category);
    }
    ...
    if (currentFilter.price !== 'semua') {
        switch (currentFilter.price) {
            case 'murah':
                ...
                break;
            case 'sedang':
                filteredProducts = filteredProducts.filter(product => product.price > 50000 && product.price <= 200000);
                break;
            case 'tinggi':
    ...
    domElements.productModalContent.innerHTML = `
        <div class="product-detail-container">
            <div class="product-detail-gallery">
                <img src="${product.image}" alt="${product.name}" class="product-detail-image" id="product-detail-image">
            ...
            <div class="product-detail-content">
                ...
                <div class="product-detail-actions">
                    <button class="btn btn-outline" id="add-to-wishlist" data-id="${product.id}">
                        <i class="far fa-heart"></i> Wishlist
                    </button>
                    <button class="btn btn-primary" id="add-to-cart-detail" data-id="${product.id}">
...
const addProductDetailEventListeners = (product) => {
    // Toggle media button (image/video)
    ...
    if (toggleMediaBtn) {
        ...
        toggleMediaBtn.addEventListener('click', () => {
            ...
            if (showingVideo) {
                ...
                productVideo.play();
                toggleMediaBtn.innerHTML = '<i class="fas fa-image"></i> Tampilkan Gambar';
            } else {
                productImage.style.display = 'block';
                productVideo.style.display = 'none';
                productVideo.pause();
                toggleMediaBtn.innerHTML = '<i class="fas fa-video"></i> Tampilkan Video';
            }
        });
    }
    ...
    if (addToWishlistBtn) {
        addToWishlistBtn.addEventListener('click', () => {
            ...
            if (isInWishlist) {
                ...
                addToWishlistBtn.innerHTML = '<i class="fas fa-heart"></i> Dalam Wishlist';
...
const processPayment = () => {
    ...
    if (selectedPaymentMethod === 'midtrans') {
        ...
        showNotification('Silakan transfer sesuai instruksi di atas. Konfirmasi via WhatsApp setelah transfer.', 'info');
        
        // For bank transfer, we just show a success message
        setTimeout(() => {
            showNotification('Pesanan Anda telah diterima. Silakan lakukan transfer dalam 24 jam.', 'success');
...
const setupProductEventDelegation = () => {
    // Event delegation untuk semua product buttons
    document.addEventListener('click', (e) => {
        ...
        // Add to cart buttons - gunakan event delegation untuk menghindari duplikasi
...
const setupEventListeners = () => {
    ...
    // Navigasi smooth scroll dengan active state langsung
    const navLinks = document.querySelectorAll('.nav-link, .mobile-nav-link');
    navLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            if (targetId.startsWith('#')) {
                ...
                if (targetElement) {
                    // Set flag manual navigation
                    isManualNav = true;
                    
                    // Set active state langsung
                    ...
                    // Reset manual nav flag setelah scroll selesai
                    navClickTimeout = setTimeout(() => {
                        isManualNav = false;
                    }, 1500); // Waktu untuk scroll selesai
    ...
    // Update active nav saat scroll - tapi jangan update kalau baru aja manual nav
    ...
    // Category cards - langsung set active ke produk saat diklik
    ...
    categoryCards.forEach(card => {
        card.addEventListener('click', () => {
            ...
            if (produkSection) {
                ...
                // Set active nav langsung ke produk
    ...
    if (domElements.contactForm) {
        domElements.contactForm.addEventListener('submit', (e) => {
            e.preventDefault();
            showNotification('Pesan Anda telah berhasil dikirim! Kami akan menghubungi Anda segera.', 'success');
            domElements.contactForm.reset();
        });
    }
    
    // Add event delegation untuk dynamic cart items
    document.addEventListener('click', (e) => {
        // Decrease quantity
        if (e.target.closest('.decrease-quantity')) {
            const productId = parseInt(e.target.closest('.decrease-quantity').getAttribute('data-id'));
            updateCartItemQuantity(productId, -1);
        }
        
        // Increase quantity
        if (e.target.closest('.increase-quantity')) {
            const productId = parseInt(e.target.closest('.increase-quantity').getAttribute('data-id'));
            updateCartItemQuantity(productId, 1);
        }
...
const initializeApp = () => {
    ...
    // Setup product event delegation (HANYA SEKALI)
    ...
    // Update active nav saat load
    updateActiveNav();
    
    // Show welcome message for demo
    setTimeout(() => {
        showNotification('Selamat datang di demo UMKM Digital! Gunakan akun demo untuk menjelajahi fitur.', 'info');
    }, 1000);
};
